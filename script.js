    ...
    if (gamepad) {
        ...
        if (!elements.choicesContainer.classList.contains('hidden')) {
            ...
            if (choicesElements.length > 0) {
                ...
                if (isGamepadButtonPressed(GAMEPAD_DPAD_DOWN, gamepad)) {
                ...
                } else if (isGamepadButtonPressed(GAMEPAD_DPAD_UP, gamepad)) {
                    if (currentSelection !== -1) {
                        choicesElements[currentSelection].classList.remove('gamepad-selected');
                    }
        ...
        // Action Button (A)
        if (isGamepadButtonPressed(GAMEPAD_BUTTON_A, gamepad)) {
            if (!elements.choicesContainer.classList.contains('hidden')) {
        ...
        prevGamepadButtonStates[GAMEPAD_BUTTON_A] = gamepad.buttons[GAMEPAD_BUTTON_A] && gamepad.buttons[GAMEPAD_BUTTON_A].pressed;
        prevGamepadButtonStates[GAMEPAD_DPAD_UP] = gamepad.buttons[GAMEPAD_DPAD_UP] && gamepad.buttons[GAMEPAD_DPAD_UP].pressed;
        prevGamepadButtonStates[GAMEPAD_DPAD_DOWN] = gamepad.buttons[GAMEPAD_DPAD_DOWN] && gamepad.buttons[GAMEPAD_DPAD_DOWN].pressed;
