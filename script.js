...
const story = [
    ...
    ,{
        background: "https://example.com/approach-scene.jpg",
    ...
    // Scene 4 (Ignore path)
    {
        background: "https://example.com/ignore-scene.jpg",
    ...
    // Scene 5 (Wave path)
    {
        background: "https://example.com/wave-scene.jpg",
    ...
    {
        background: "https://example.com/conversation-scene.jpg",
    ...
    {
        background: "https://example.com/walking-scene.jpg",
    ...
    {
        background: "https://example.com/apology-scene.jpg",
    ...
    {
        background: "https://example.com/lonely-scene.jpg",
    ...
    {
        background: "https://example.com/second-chance-scene.jpg",
    ...
    {
        background: "https://example.com/parting-scene.jpg",
